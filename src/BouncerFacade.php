 ...
 * @method static \Illuminate\Auth\Access\Response authorizeForRestrictedModel(string $ability, Model $restrictedModel, Model|null $model)
 * @method static bool canForRestrictedModel(string $ability, Model $restrictedModel, Model|null $model)
 * @method static bool canAnyForRestrictedModel(array $abilities, Model $restrictedModel, Model|null $model)
 * @method static bool cannotForRestrictedModel(string $ability, Model $restrictedModel, Model|null $model)
